...
fn build_scores_table(results: &str) -> HashMap<&str, TeamScores> {
    ...
    for line in results.lines() {
        ...
        let default_scores = TeamScores::default();
        let team_1 = scores.get(team_1_name).unwrap_or(&default_scores);
        scores.insert(
            team_1_name,
            TeamScores {
        ...
        let team_2 = scores.get(team_2_name).unwrap_or(&default_scores);
        scores.insert(
            team_2_name,
            TeamScores {
